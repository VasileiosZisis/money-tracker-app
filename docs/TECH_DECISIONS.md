...
- optional tag must belong to the selected category
...
- tags belong to exactly one category
- tag names are unique within a category
- tags can classify transactions, planned bills, and planned income
- tags are optional
- when a category changes, an old tag is not preserved unless the submitted tag belongs to the new category
- deleting a tag sets related transaction/planned item `tagId` to `null`
...
- optional planned-bill tag must belong to the selected expense category
...
- generated planned-bill payment transactions inherit the planned bill category and optional tag
...
- optional planned-income tag must belong to the selected income category
...
- generated planned-income transactions inherit the planned income category and optional tag
...
- optional tag must resolve inside the selected category before confirm
