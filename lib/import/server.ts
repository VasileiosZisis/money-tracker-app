...
export type ImportPreviewActionResult = ActionResultWithData<ImportPreviewResult>;

export type ConfirmImportResult = ActionResultWithData<{
...
export async function previewImportForUser(
  userId: string,
  formData: FormData,
...
export async function confirmImportForUser(
  userId: string,
