...
const CurrencyInput = React.forwardRef<HTMLInputElement, CurrencyInputProps>(
  ({ className, currency, wrapperClassName, ...props }, ref) => (
    <div
      className={cn(
        "rounded-lg border border-input bg-background/70 px-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.25)] transition-colors focus-within:border-primary/40 focus-within:ring-3 focus-within:ring-ring/70",
        wrapperClassName,
      )}
    >
